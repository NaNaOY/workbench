...
- **期货面板**：7 个新能源与工业品种自选行情、真实分时与日 K、关键价位红线、六氟磷酸锂现货价格入口、产业链联动、手动/自动刷新和本机价格提醒；行情用于个人研究，不构成投资建议。
...
- 专注模式会直接沿用当前选中今日待办的场景背景，并同步对应的计时器强调色。
- 个人台账下拉筛选层级已修复，菜单不会再被台账卡片遮挡；台账卡片改为紧凑的场景行布局。
- 信息学题单、期货风险表格的页面密度与文字可读性已优化。
